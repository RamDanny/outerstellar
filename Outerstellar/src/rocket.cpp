...
void rocket::detach2(float spd) {
    rlPushMatrix();
    rlTranslatef(body1.x, body1.y, body1.z);
    rlRotatef(spd * 50, 0, 1, 0);
    rlTranslatef(-body1.x, -body1.y, -body1.z);
    DrawCube(body1, 3.0f, 8.0f, 3.0f, WHITE);
    DrawCubeWires(body1, 3.0f, 8.0f, 3.0f, DARKGRAY);
    rlPopMatrix();
...
void rocket::detach3(float spd) {
    ...
    rlPushMatrix();
    rlTranslatef(body2.x, body2.y, body2.z);
    rlRotatef(spd * 50, 0, 1, 0);
    rlTranslatef(-body2.x, -body2.y, -body2.z);
    DrawCube(body2, 3.0f, 12.0f, 3.0f, WHITE);
    DrawCubeWires(body2, 3.0f, 12.0f, 3.0f, DARKGRAY);
